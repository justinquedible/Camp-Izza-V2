...
export const Groups: React.FC<Props> = () => {
        ...
        <div>
            <Modal show={showPopup} onHide={handleClose}>
                ...
                <Modal.Body>
                    <ol>
                    {showList3.map(item => (
                        <li> {item.firstName} {item.lastName} &nbsp;<Button variant="success" size={"sm"} onClick={()=>assignCamper(item.id)}> Assign </Button></li>
                    ))}
                    </ol>
                </Modal.Body>
                <Modal.Footer>
        ...
        <div>
            <Modal show={showCounselorPopup} onHide={handleCounselorClose}>
                ...
                <Modal.Body>
                    <ol>
                        {showList3.map(item => (
                            <li> {item.firstName} {item.lastName} &nbsp;<Button variant="success" size={"sm"} onClick={()=>assignCounselor(item.id)}> Assign </Button></li>
                        ))}
                    </ol>
                </Modal.Body>
                <Modal.Footer>
    ...
    const handleAll = () => {
        ...
        setAll(true);
        setDates(false)
        setCoconuts(false);setTrees(false);setLeaders(false);
    }
    ...
    const Dates = () =>
        <div>
            <h4> ✏️ Edit Group: Dates 1 </h4><br />
            <div className={"row"}>
                <div className={"column groupBox"}>
                    Members
                    <ul>
                        {showList8.map(item => (
                            <li> {item.firstName} {item.lastName} &nbsp;<Button variant="danger" size={"sm"} onClick={()=>removeCounselor(item.id)}> Remove </Button></li>
                        ))}
                    </ul>
                    <ol>
                        {showList1.map(item => (
                            <li> {item.firstName} {item.lastName} &nbsp;<Button variant="danger" size={"sm"} onClick={()=>removeCamper(item.id)}> Remove </Button></li>
                        ))}
                    </ol>
                </div>
                <div className={"column"}>
                    <Button variant="primary" onClick={() =>handlePopup(1)}> + Assign Camper </Button><br /><br />
                    <Button variant="outline-primary" onClick={() =>handleCounselorPopup(1)}> + Assign Counselor </Button>
                </div>
            </div><br /><br />
            <h4> ✏️ Edit Group: Dates 2 </h4><br />
            <div className={"row"}>
                <div className={"column groupBox"}>
                    Members
                    <ul>
                ...
                <div className={"column"}>
                    <Button variant="primary" onClick={() =>handlePopup(2)}> + Assign Camper </Button><br /><br />
                    <Button variant="outline-primary" onClick={() =>handleCounselorPopup(2)}> + Assign Counselor </Button>
                </div>
            </div>
        </div>
    ...
    const handleDates = () => {
        ...
        setSelected("dates");
        setDates(true);
        setAll(false);setCoconuts(false);setTrees(false);setLeaders(false);
    ...
    const Coconuts = () =>
        <div>
            <h4> ✏️ Edit Group: Coconuts 1 </h4><br />
            <div className={"row"}>
                <div className={"column groupBox"}>
                    Members
                    <ul>
            ...
            <h4> ✏️ Edit Group: Coconuts 2 </h4><br />
            <div className={"row"}>
                <div className={"column groupBox"}>
                    Members
                    <ul>
    ...
    const handleCoconuts = () => {
        ...
        setCoconuts(true);
        setDates(false);
        setAll(false);setTrees(false);setLeaders(false);
    }


    const Trees = () =>
        <div>
            <h4> ✏️ Edit Group: Trees 1 </h4><br />
            <div className={"row"}>
                <div className={"column groupBox"}>
                    Members
                    <ul>
    ...
    const handleTrees = () => {
        ...
        setTrees(true);
        setDates(false);
        setAll(false);setCoconuts(false);setLeaders(false);
    }


    const Leaders = () =>
        <div>
            <h4> ✏️ Edit Group: Young Leaders </h4><br />
            <div className={"row"}>
                <div className={"column groupBox"}>
                    Members
                    <ul>
    ...
    const handleLeaders = () => {
        ...
        setLeaders(true);
        setDates(false);
        setAll(false);setCoconuts(false);setTrees(false);
    }
    ...
    return (
        ...
        <Container className="Admin-Buttons">
            ...
            <div className={"buttonToggle"}>
                <Button variant="dark" className={"groupBtn"} onClick={handleAll}> ALL </Button>
                <Button variant="success" className={"groupBtn"} onClick={handleDates}> Dates </Button>
                <Button variant="warning" className={"groupBtn"} onClick={handleCoconuts}> Coconuts </Button>
                <Button variant="danger" className={"groupBtn"} onClick={handleTrees}> Trees </Button>
                <Button variant="info" className={"groupBtn"} onClick={handleLeaders}> Young Leaders </Button>
                {showAll ? <All />: null}
