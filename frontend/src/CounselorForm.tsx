...
export default function CounselorForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Update emergency_contacts of counselor
    await axios
    ...
    // Update counselor_medical_record of counselor
    await axios.put(
      process.env.REACT_APP_API +
        "api/counselor_medical_records/updateCounselor_Medical_Record/" +
    ...
    <div className={"CounselorForm"}>
      ...
      <Container className="Text-Form">
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Row>
            <Form.Group as={Col} className="form-field-md" controlId="firstName">
              <Form.Label>
                <b>* </b>First Name
              </Form.Label>
              <Form.Control required value={counselorValues.firstName} onChange={handleCounselorChange("firstName")} />
            </Form.Group>
            <Form.Group as={Col} className="form-field-md" controlId="lastName">
              <Form.Label>
                <b>* </b>Last Name
              </Form.Label>
              <Form.Control required value={counselorValues.lastName} onChange={handleCounselorChange("lastName")} />
            </Form.Group>
            <Form.Group as={Col} className="form-field-sm" controlId="counselorGender">
              <Form.Label>
                <b>* </b>Gender
              </Form.Label>
              <Form.Control
            ...
            <Form.Group as={Col} className="form-field-md" controlId="counselorDob">
              <Form.Label>
                <b>* </b>Date of Birth
              </Form.Label>
              <input
          ...
          <Row>
            <Form.Group as={Col} className="form-field-md" controlId="phone">
              <Form.Label>
                <b>* </b>Phone Number
              </Form.Label>
              <input
            ...
            <Form.Group as={Col} className="form-field-md" controlId="phone">
              ...
              <input
                ...
                onChange={handleCounselorChange("altPhone")}
              />
            </Form.Group>
            <Form.Group as={Col} className="form-field-md" controlId="email">
              <Form.Label>
                <b>* </b>Email
              </Form.Label>
          ...
          <Row>
            <Form.Group as={Col} className="form-field-md" controlId="emergencyContact1FirstName">
              <Form.Label>
                <b>* </b>First Name
              </Form.Label>
              <Form.Control
            ...
            <Form.Group as={Col} className="form-field-md" controlId="emergencyContact1LastName">
              <Form.Label>
                <b>* </b>Last Name
              </Form.Label>
          ...
          <Row>
            <Form.Group as={Col} className="form-field-md" controlId="emergencyContact1Relation">
              <Form.Label>
                <b>* </b>Relation to Camper(s)
              </Form.Label>
              <Form.Control required value={emergency1Values.relation} onChange={handleEmergency1Change("relation")} />
            </Form.Group>
            <Form.Group as={Col} className="form-field-md" controlId="emergencyContact1Phone">
              <Form.Label>
                <b>* </b>Phone Number
              </Form.Label>
              <input
          ...
          <Row>
            <Form.Group as={Col} className="form-field-md" controlId="emergencyContact2FirstName">
              <Form.Label>
                <b>* </b>First Name
              </Form.Label>
              <Form.Control
            ...
            <Form.Group as={Col} className="form-field-md" controlId="emergencyContact2LastName">
              <Form.Label>
                <b>* </b>Last Name
              </Form.Label>
          ...
          <Row>
            <Form.Group as={Col} className="form-field-md" controlId="emergencyContact2Relation">
              <Form.Label>
                <b>* </b>Relation to Camper(s)
              </Form.Label>
              <Form.Control required value={emergency2Values.relation} onChange={handleEmergency2Change("relation")} />
            </Form.Group>
            <Form.Group as={Col} className="form-field-md" controlId="emergencyContact2Phone">
              <Form.Label>
                <b>* </b>Phone Number
              </Form.Label>
              <input
